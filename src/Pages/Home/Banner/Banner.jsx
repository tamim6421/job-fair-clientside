    ...
    return (
        <div className=" mt-10 shadow-md flex flex-col md:flex-row h-[600px]">
            <div className='flex-[1] p-3'>
                ...
                className='text-green-500 text-6xl drop-shadow-lg font-extrabold mt-20'  data-aos="fade-up" >Find  <span className='text-orange-400'> your job </span>  <span className='text-purple-400'>&</span> <br /> make sure goal <span className='text-orange-400'>!!</span></motion.p>
